...
- Add per-recipe `doc.md` documentation, a `::: example` directive to embed live component previews, and a `RecipeDocRenderer` that renders docs as HTML or Markdown, to ease wiring official kits into ux.symfony.com and, in the future, previewing community kits
